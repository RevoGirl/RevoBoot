...
void initCPUStruct(void)
{
	...
	gPlatform.CPU.CurrCoef		= STATIC_CPU_CurrCoef;		// aka busratio=nn
	gPlatform.CPU.MaxCoef		= STATIC_CPU_MaxCoef;		// Zero means no turbo?

	gPlatform.CPU.CurrDiv		= STATIC_CPU_CurrDiv;		//
	gPlatform.CPU.MaxDiv		= STATIC_CPU_MaxDiv;		// 
